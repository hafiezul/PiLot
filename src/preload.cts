...
const api: PiLotApi = {
  ...
  getEditorState: (projectPath, taskPath) => ipcRenderer.invoke("editors:get", projectPath, taskPath),
  setPreferredEditor: (projectPath, taskPath, editor) => ipcRenderer.invoke("editors:set-preferred", projectPath, taskPath, editor),
  ...
  openTaskPathInEditor: (projectPath, taskPath, editor, filePath) => ipcRenderer.invoke("tasks:open-in-editor", projectPath, taskPath, editor, filePath),
