...
import type { DiagnosticsApi } from "./diagnostics.js";
...
export type PiLotApi = ProviderApi & AgentSettingsApi & DiagnosticsApi & PreferencesApi & ApplicationsApi & ProjectsApi & {
